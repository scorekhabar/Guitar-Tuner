...
Application.prototype.start = function () {
  ...
  swal
    .fire({
      confirmButtonText: "Start Tuning",
      target: ".tuner",
      didOpen: () => {
        Swal.getPopup().style.border = "none";
        Swal.getPopup().style.boxShadow = "none";
        Swal.getPopup().style.background = "transparent";
        Swal.getPopup().style.padding = "0";
      },
      customClass: {
    ...
    .then(function () {
      self.tuner.init();
      const tuner_ele = document.querySelector(".tuner");
      if (tuner_ele) {
        tuner_ele.style.background = "none";
      }
